...
import { CalendarIcon, CheckCircle, Clock, Mail, MapPin, Phone } from "lucide-react"
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-background to-muted">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl text-red-600">Book a Free Consultation</h1>
              ...
              {submitted ? (
                <div className="flex flex-col items-center justify-center p-8 text-center h-full">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Your consultation request has been submitted. We'll contact you shortly to confirm your appointment.
                  </p>
      ...
      <section className="w-full py-12 md:py-24 bg-muted">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-10">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-red-600">Frequently Asked Questions</h2>
            <p className="max-w-[800px] text-muted-foreground md:text-xl/relaxed">
